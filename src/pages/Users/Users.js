...
import { USERS_ENDPOINT } from '../../Routes/APIEndpoints';
import './Users.css';
...
function Users() {
    ...
    const handleSearchTextChange = event => {
        ...
        _updateDisplayUsers(value);
    }
    }
    const _updateDisplayUsers = (value) => {
        const dispUsers=[];
...
/* birth-mount -did mount
growing-update -shouldupdate,did update
death-un-mount-will unmount*/